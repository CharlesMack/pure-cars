...
<html>
<head>
    <title>Pure Cars</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <style>
        body {
            font-family: 'Segoe UI', sans-serif;
            background: #f3e5f5; /* light pinkish purple */
            color: #333;
            text-align: center;
            padding: 50px 20px;
            margin: 0;
...
<body>
    ...
    <div class="shortcuts">
        <div class="shortcut" onclick="parent.navigateToUrl('https://www.vandevere.com/')">
            ...
            <div>VanDevere Buick Kia</div>
            <div class="desc">Akron - Buick, Kia - New & Used - $20k-$50k</div>
        </div>
        <div class="shortcut" onclick="parent.navigateToUrl('https://www.serraautopark.com/')">
            <div class="icon-circle">🚙</div>
            <div>Serra Auto Park</div>
            <div class="desc">Akron - Acura, Chevy, Honda - New & Used - $15k-$60k</div>
        </div>
        <div class="shortcut" onclick="parent.navigateToUrl('https://www.fredmartinnissan.com/')">
            <div class="icon-circle">🛻</div>
        ...
        <div class="shortcut" onclick="parent.navigateToUrl('https://www.toyotaofnorthcanton.com/')">
            ...
            <div class="desc">North Canton - Toyota - New & Used - $20k-$50k</div>
        </div>
        <div class="shortcut" onclick="parent.navigateToUrl('https://www.mercedesbenzcanton.com/')">
            <div class="icon-circle">🚖</div>
            <div>Mercedes-Benz of Canton</div>
            <div class="desc">Canton - Mercedes - Luxury New & Used - $40k-$100k</div>
        </div>
        <div class="shortcut" onclick="parent.navigateToUrl('https://www.kenganleyauto.com/')">
            <div class="icon-circle">🚗</div>
            <div>Ken Ganley Auto Group</div>
            <div class="desc">Cleveland - Various Brands - New & Used - $15k-$80k</div>
        </div>
        <div class="shortcut" onclick="parent.navigateToUrl('https://www.toyotaclevelandheights.com/')">
            <div class="icon-circle">🚙</div>
    ...
    <div class="check-tabs">
        ...
        <div class="tab-item" onclick="parent.navigateToUrl('https://www.spitzerchevroletnorthcanton.com/')">
            <div class="tab-icon">🚙</div>
            <div>
                <div class="tab-title">Spitzer Chevrolet North Canton</div>
    ...
    <script>
        function filterShortcuts() {
            ...
            shortcuts.forEach(function(shortcut) {
                var text = shortcut.textContent.toLowerCase();
